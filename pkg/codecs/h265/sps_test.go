	...
	for _, ca := range []struct {
		...
		},
		{
			...
			SPS{
				...
				MaxDecPicBufferingMinus1:             []uint32{3},
				MaxNumReorderPics:                    []uint32{2},
				MaxLatencyIncreasePlus1:              []uint32{0},
				Log2DiffMaxMinLumaCodingBlockSize:    2,
				Log2DiffMaxMinLumaTransformBlockSize: 3,
				...
				ShortTermRefPicSets: []*SPS_ShortTermRefPicSet{
					{
						...
						DeltaPocS0:          []int32{-1},
						UsedByCurrPicS0Flag: []bool{true},
						DeltaPocS1:          []int32{1, 3},
						UsedByCurrPicS1Flag: []bool{true, false},
					},
					{
						InterRefPicSetPredictionFlag: true,
						DeltaRpsSign:                 true,
						AbsDeltaRpsMinus1:            1,
						NumNegativePics:              2,
						NumPositivePics:              1,
						DeltaPocS0:                   []int32{-1, -3},
						UsedByCurrPicS0Flag:          []bool{true, true},
						DeltaPocS1:                   []int32{1},
						UsedByCurrPicS1Flag:          []bool{true},
					},
					{
						InterRefPicSetPredictionFlag: true,
						DeltaRpsSign:                 true,
						...
						NumNegativePics:              3,
						NumPositivePics:              0,
						DeltaPocS0:                   []int32{-4, -6, -8},
						UsedByCurrPicS0Flag:          []bool{true, true, true},
					},
					{
						InterRefPicSetPredictionFlag: true,
						AbsDeltaRpsMinus1:            1,
